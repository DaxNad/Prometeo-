        ...
        *,
        ...
        stmt = text(
            ...
            SELECT
                ...
                COUNT(*) FILTER (WHERE decision_mode LIKE 'local-escalation%') AS escalation_total_count,
                COUNT(*) FILTER (WHERE decision_mode = 'local-escalation-atlas') AS atlas_escalation_count,
        ...
        return {
            ...
            "escalation_total_count": row["escalation_total_count"],
            "atlas_escalation_count": row["atlas_escalation_count"],
