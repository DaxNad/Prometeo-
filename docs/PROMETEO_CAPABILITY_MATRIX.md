...
| ZAW saturation reasoning | `STRUCTURAL_READY` | dominio stazioni | planner, ATLAS | `evals/prometeo_pilot_cases/case_001_station_saturation.json` | Inferenze opache | Stabilizzare expected constraints sintetici |
| CP final block reasoning | `STRUCTURAL_READY` | dominio stazioni | planner, ATLAS | `evals/prometeo_pilot_cases/case_002_final_check_block.json` | Mancata propagazione blocker | Aggiungere output explainability minimo |
| Shared component conflict | `STRUCTURAL_READY` | componente condiviso | ATLAS, planner | `evals/prometeo_pilot_cases/case_003_shared_component_conflict.json` | Priorita non motivata | Misurare conflitto evitato |
